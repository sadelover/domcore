...
bool COPCConnection::AddGroup(int nUpdateRate)
{
	if (NULL == m_pGroup){
...
bool COPCConnection::GetUpdateTime20( COleDateTime& oleUpdate ,bool& bUpdateTimeAsync20)
{
	if(m_pGroup)
	{
		return m_pGroup->GetUpdateTime20(oleUpdate,bUpdateTimeAsync20);
	}
	return false;
}