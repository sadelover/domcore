	...
	if ((m_pServer->IsConnected ()) && (m_pIItemMgt != NULL))
	{
		...
		if (pItemArray != NULL)
		{
			...
			for (dwIndex = 0; dwIndex < dwCount; dwIndex++)
			{
				...
				pItemArray [dwIndex].vtRequestedDataType = VT_EMPTY; // Requested data type
			}
...
bool CKGroup::GetUpdateTime20( COleDateTime& oleUpdate,bool& bUpdateTimeAsync20 )
{
	if(m_pIDataSink20)
		return m_pIDataSink20->GetUpdateTime20(oleUpdate,bUpdateTimeAsync20);
	return false;
}
