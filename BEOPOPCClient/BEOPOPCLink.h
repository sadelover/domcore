...
{
public:
	COPCEngine(wstring strOPCServerIP,int nSleep = 5,int nMutilCount =1,bool bUseThread = false,int nSleepFromDevice = 50,int nPollSleep = 5,int nPollSleepFromDevice = 60,bool bDisableCheckQuality=false);
	~COPCEngine(void);
