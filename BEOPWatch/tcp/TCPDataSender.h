...
public:
	...
	void	ReSet(string strHost,u_short portnumer,string strTCPName,int nReConnectInterval = 30,UINT writebuffersize = 1024);
...
private:
	...
	int						m_nRecSize;
	COleDateTime			m_oleActiveTime;				//最后活跃时间
};
