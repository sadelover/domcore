...
enum OPCPOINTTYPE
{
	...
	POINTTYPE_OBIX,
	POINTTYPE_LOGIX,
	POINTTYPE_MOXA_TCP_SERVER,
	POINTTYPE_CORE_STATION,
	POINTTYPE_KNX,
	POINTTYPE_DLT645,
	POINTTYPE_ABSLC
};
...
bool    IsCoreStationPoint() const;
bool    IsDLT645Point() const;
bool    IsOPCUAPoint() const;
bool	 IsBacnetPyPoint() const;
bool    IsPersagyControllerPoint() const;
bool	 IsObixPoint() const;
bool     IsLogixPoint() const;
bool     IsABSLCPoint() const;
bool     IsMoxaTCPServerPoint() const;
bool     IsKNXPoint() const;
