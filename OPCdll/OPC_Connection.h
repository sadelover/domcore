...
public:
	...
	bool	GetItemValueBuffer(const wstring& strItemName, wstring &strValue);		//通过ItemName 拿值
...
protected:
	...
	bool			m_isconnected;
	bool		m_bAddItemSuccess;		//至少要添加一次数据
	bool		m_bAddGroupSuccess;		//添加组成功
