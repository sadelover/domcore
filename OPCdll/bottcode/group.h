...
public:
	...
	void 	PrintLog(const CString &strLog,bool bSaveLog = true);
	IKDataSink20* GetIKDataSink20();
	bool	GetUpdateTime20(COleDateTime& oleUpdate,bool& bUpdateTimeAsync20, bool bOutAsync20 = true);					//获取异步数据更新时间
	bool	GetAsync20ErrorItem(CObArray &cItemList);
	bool	GetSync20ErrorItem(CObArray &cItemList);
	bool	GetAsync20WriteItem(CObArray &cItemList);	//获取异步写成功OPC句柄
...
private:
	...
	hash_map<CKItem*,int>		m_mapItemError;		//item  Handle 无效
